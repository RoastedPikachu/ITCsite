      ...
      <main>
        <section className="relative pt-[213px] pb-[140px] px-[135px] w-full">
          ...
          <div className="mt-[185px]">
            ...
            <div className="grid grid-cols-2 gap-x-[115px] items-center mt-[90px] w-full h-auto">
              <div className="relative w-full h-[27.5vw] bg-[url('/static/junarmy/Registration.png')] rounded-[35px]">
                <div className="absolute left-0 bottom-0 w-full">
                  ...
                  <p className="ml-[30px] mb-[30px] max-w-[355px] text-white text-[2.0625rem] text-left font-['Montserrat'] font-semibold leading-[1.25]">
                  ...
                  <div className="relative flex justify-center items-center w-full h-[194px] bg-[#0a0a0a] border-[1px] border-[#323232] rounded-[35px]">
                    <a
                      href=""
                      className="px-[127px] py-[25px] w-auto h-auto bg-[#202020] rounded-[20px] text-white text-[1.5rem] text-center font-['Montserrat'] font-bold uppercase"
                    >
                      ЗАРЕГИСТРИРОВАТЬСЯ
                    </a>
                  </div>
              ...
              <div className="relative w-full h-[27.5vw] bg-[url('/static/junarmy/Declaration.png')] rounded-[35px]">
                <div className="absolute left-0 bottom-0 w-full">
                  ...
                  <p className="ml-[30px] mb-[30px] max-w-[640px] text-white text-[2.0625rem] text-left font-['Montserrat'] font-semibold leading-[1.25]">
